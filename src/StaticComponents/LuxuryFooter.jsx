...
const Footer = () => {
  ...
  // Quick Links Data (from Header)
  const quickLinks = [
    { icon: Home, label: 'Home', to: '/' },
    { icon: User, label: 'About', to: '/about' },
    { icon: Package, label: 'Product', to: '/products' },
    // { icon: Gift, label: 'Metal Trophy', to: '#' },
    // { icon: Heart, label: 'Table Top', to: '#' },
    // { icon: Crown, label: 'memento', to: '#' },
    // { icon: Star, label: 'Metal Key-Chain', to: '#' },
    // { icon: Star, label: 'Medals', to: '#' },
    { icon: Image, label: 'Gallery', to: '/gallery' },
    { icon: Image, label: 'E-Brochure', to: '/brochure' },
    { icon: PhoneIcon, label: 'Contact', to: '/contact' }
  ];

  // Social Media Links
  const socialLinks = [
    { icon: Facebook, label: 'Facebook', to: '#', color: 'hover:text-[#133FAD]' },
    { icon: Instagram, label: 'Instagram', to: '#', color: 'hover:text-[#ED3237]' },
    { icon: Twitter, label: 'Twitter', to: '#', color: 'hover:text-[#969394]' },
    { icon: Linkedin, label: 'LinkedIn', to: '#', color: 'hover:text-[#133FAD]' },
    { icon: Youtube, label: 'YouTube', to: '#', color: 'hover:text-[#ED3237]' }
  ];
